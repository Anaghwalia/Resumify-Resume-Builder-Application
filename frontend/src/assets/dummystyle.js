...
footerLink: "flex justify-center gap-4 mt-3 [&>a]:text-slate-500 [&>a]:hover:text-fuchsia-500 [&>a]:transition-colors",
copyright:"mt-4 text-xs sm:text-sm text-slate-400 font-medium"
...
export const infoStyles = {
  ...
  // CertificationInfo 
  certContainer: "mb-3",
  certTitle: "font-semibold text-gray-800",
  certDetails: "flex items-center gap-2 mt-1", // This makes issuer and year stay together
  certIssuer: "text-sm text-gray-600",
  certYear: "text-xs text-gray-500",
  ...
  eduPercentage: "font-semibold text-sm text-gray-700 bg-gray-100 px-2 py-0.5 rounded-md",
