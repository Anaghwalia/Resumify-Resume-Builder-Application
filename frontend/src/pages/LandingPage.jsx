        ...
        <div className={landingPageStyles.headerContainer}>
          <div className={landingPageStyles.logoContainer}>
            <div className={landingPageStyles.logoIcon}>
              <LayoutTemplate
                className={landingPageStyles.logoIconInner}
              ></LayoutTemplate>
            </div>
            <span className={landingPageStyles.logoText}>Resumify</span>
          </div>
          {/* Mobile Menu Btn */}
          <button
          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                Your skills deserve a world-class presentation. We provide
                recruiter-approved, ATS-friendly templates. Build a resume that
                truly reflects your professional value and gets you noticed.
              </p>
                ...
                {[
                  {
                    value: "5",
                    label: "Templates",
                    gradient: "from-violet-600 to to-fuchsia-600",
                  },
                  {
                    value: "5 Min",
                    label: "Build Time",
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              ...
              <p className={landingPageStyles.featuresDescription}>
                We combine recruiter-approved designs with guaranteed ATS
                optimization, ensuring your resume impresses both bots and
                humans.
              </p>
            </div>
            <div className={landingPageStyles.featuresGrid}>
              {[
                ...
                },
                {
                  ...
                  title: "Pro Templates",
                  description:
                    "Choose from lots of recruiter-approved, industry-specific templates",
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            ...
            <strong>Anagh Walia</strong>
          </p>
          <div className={landingPageStyles.footerLink}>
            <a
              href="https://github.com/Anaghwalia"
              target="_blank"
          ...
          <small className={landingPageStyles.copyright}>
