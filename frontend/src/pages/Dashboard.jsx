...
const Dashboard = () => {
  ...
  const calculateCompletion = (resume) => {
    ...
    resume.education?.forEach((edu) => {
      ...
      if(edu.percentage) completedFields++;
    });
  ...
  const fetchAllResumes = async () => {
    try {
      ...
      // Add completion precentage to all resumes
      const resumsWithCompletion = response.data.map((resume) => ({
        ...resume,
        completion: calculateCompletion(resume),
      }));
      setAllResumes(resumsWithCompletion);
    } catch (error) {
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyStateWrapper}>
            ...
            <p className={styles.emptyText}>
              You haven't created any resume yet. Start building you
          ...
          <div className={styles.grid}>
            ...
            {allResumes.map((resume) => (
              ...
              <ResumeSummaryCard
                ...
                // This is SAFE. It checks if resume.createdAt exists first.
                isNew={
                  resume.createdAt
                    ? differenceInDays(new Date(), new Date(resume.createdAt)) <
                      7
                    : false
                }
              />
