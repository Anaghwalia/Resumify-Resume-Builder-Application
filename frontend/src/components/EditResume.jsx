...
import { dataURLtoFile, inlineAllComputedStyles } from "../utils/helper";
...
const EditResume = () => {
  ...
  // It will help in choosing preview and also downloading the resume
  ...
  try {
    ...
    // 1. Find all the links and get their positions BEFORE making the canvas
    ...
    // --- THIS IS THE OTHER NEW PART ---
    // 2. Add the invisible links to the PDF
  ...
  return (
    <DashboardLayout>
        ...
        <div className={containerStyles.grid}>
          ...
          <div className="hidden lg:block">
            <div className={containerStyles.previewContainer}>
              ...
              <div
                className="preview-continer relative"
      ...
      {/* Thumbnail generation area - Corrected */}
